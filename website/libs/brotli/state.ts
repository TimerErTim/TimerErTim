...
import { CHUNK_SIZE } from "./internal/constants";
import { log2floor } from "./internal/helpers";
import { InputStream } from "./internal/input";
import { toUsAsciiBytes } from "./internal/encoding";
import { Transforms } from "./internal/transforms";
import { buildHuffmanTable } from "./internal/tables";
import {
...
export class State {
  ...
  static setDictionaryData(newData: Int8Array, newSizeBits: Int32Array): void {
    ...
    State.#dictionaryData = newData as any as Int8Array<ArrayBuffer>;
  }
  ...
  static initializeDefaultDictionary(): void {
    ...
    for (let i = 0; i < n; ++i) {
      const skip = skipFlip.charCodeAt(2 * i) - 36;
      const flip = skipFlip.charCodeAt(2 * i + 1) - 36;
